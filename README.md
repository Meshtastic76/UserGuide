...
### Местоположение
| Параметр | Значение для статичной ноды | Значение для статичной ноды | Комментарий |
| -------- | --------------------------- | --------------------------- | ----------- |
| Период трансляции | Twenty Four Hours | Twenty Four Hours | 24 часа |
| Умная позиция | Выкл | Вкл |  |
| Минимальный интервал | - | Ten minutes | Активно только если включена "Умная позиция" |
| Минимальная дистанция | - | 1000 | Активно только если включена "Умная позиция" |
